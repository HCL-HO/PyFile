...
public class SampleTinkerReport {
    ...
    public static void onTryApplyFail(int errorCode) {
        ...
        switch (errorCode) {
            ...
            case TinkerUtil.ERROR_PATCH_GOOGLEPLAY_CHANNEL:
                ...
                break;
            case TinkerUtil.ERROR_PATCH_ALREADY_APPLY:
    ...
    public static void onLoadException(Throwable throwable, int errorCode) {
        ...
        if (!isCheckFail) {
            reporter.onReport("Tinker Exception:load tinker occur exception " + TinkerUtil.getExceptionCauseString(throwable));
        }
    }
    ...
    public static void onApplyDexOptFail(Throwable throwable) {
        ...
        reporter.onReport("Tinker Exception:apply tinker occur exception " + TinkerUtil.getExceptionCauseString(throwable));
    }
