...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	protected void addRefreshableView(Context context, T refreshableView) {
		addView(refreshableView, new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, 0, 1.0f));
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_mode1)) {
			mMode = a.getInteger(R.styleable.PullToRefresh_mode1, MODE_PULL_DOWN_TO_REFRESH);
		}
		...
		if (a.hasValue(R.styleable.PullToRefresh_headerBackgroundColor)) {
			setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_headerBackgroundColor, Color.WHITE));
		}
