...
//            Log.i("PIVOT", screenWidth + ", " + pivotX+"");
        } else {
...
//            Log.i("PIVOT", screenWidth + ", " + pivotX + "");
        ...
        ViewHelper.setPivotX(imageViewShadow, (float)(pivotX * 1.25));
...
//        if(!(context instanceof HomeActivity) || !(context instanceof LotteryActivity)){
